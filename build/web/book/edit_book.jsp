                    ...
                    <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                            <div class="card-body p-4 p-md-5">
                                <h3 class="mb-4 pb-2 pb-md-0 mb-md-5">Edit a Book</h3>
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <label class="form-label" for="title">Title:</label>
                                            <h4 class="form-text" id="title"><%=book.getTitle()%></h4>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            <label class="form-label" for="author">Author:</label>
                                            <h4 class="form-text" id="author"><%=book.getAuthor()%></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <h4 class="form-text" id="category"><%=book.getCategory()%></h4>
                                        </div>
                                    </div>
                                </div>
                                <form action="/BookController?action=editBook&bookId=<%=book.getBookId()%>&userId=<%=user.getUserId()%>" method="post">
                                    <div class="row">
